...
public static class GlyphReferenceRenderer
{
    ...
    // Must be installed on this machine for TryRenderFromCommand to work;
    // if not installed (or installed under a different registered family
    // name), the `new Font(...)` call below throws and the catch below
    // makes this silently return null instead of crashing.
